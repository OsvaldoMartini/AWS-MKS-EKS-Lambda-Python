...
# Decimals
DECIMAL_CALC = 2
DECIMAL_BTCUSDT = 5  # RAVE price ~0.334, needs 5 decimals

VOLUME_DEC = 5
# QTY_BUY = 10 # USDT
# QTY_BUY = 0.002 # USDT 0.005
QTY_BUY = 500  # adjust to your preferred notional size
...
# TO (RAVEUSDT):
BUY_PROFIT_CALC  = 1.008   # take profit +0.8%
BUY_LOSS_CALC    = 0.992   # stop loss   -0.8%
SELL_PROFIT_CALC = 1.008
SELL_LOSS_CALC   = 0.992
 # Verify QTY_BUY = 500 
 # against your account balance and Binance's min notional 
 # for RAVEUSDT Perp before going live. 
 # With leverage 75x, 500 RAVE × 0.334 = ~167 USDT notional but only ~2.2 USDT margin required.
...
COOLDOWN_SECONDS = 30  # don't re-enter for 30 seconds after close
